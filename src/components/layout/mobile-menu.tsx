...
export function MobileMenu() {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent
        side="left"
        className="w-[280px] border-r border-slate-200/80 bg-white/95 backdrop-blur-xl p-0"
      >
        <div className="flex h-full flex-col">
          {/* -------------------------------------------------------------- */}
          {/* Logo */}
          {/* -------------------------------------------------------------- */}
          <SheetHeader className="px-5 pt-7 pb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <SheetTitle className="text-[17px] font-semibold tracking-tight text-slate-900">
                  FuelRed
                </SheetTitle>
