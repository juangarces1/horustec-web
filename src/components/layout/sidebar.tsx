...
export function Sidebar() {
  ...
  return (
    <aside className="flex h-screen w-64 flex-col bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-white shadow-2xl">
      {/* Logo/Branding */}
      <div className="flex items-center gap-3 px-6 py-8">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">FuelRed</h1>
      ...
      <nav className="flex-1 space-y-1 px-3 py-4">
        {navItems.map((item) => {
          ...
          const isDisabled = item.href === '/configuracion'; // Placeholder route
