...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        'flex h-screen flex-col border-r border-slate-200/80 bg-white/80 backdrop-blur-xl transition-[width] duration-300',
    ...
    >
      ...
      <div
        className={cn(
          ...
          collapsed ? 'flex-col gap-2 px-0' : 'px-5'
        )}
      >
        <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-red-500 to-rose-600 shadow-md shadow-red-500/25">
        ...
        <Button
          ...
          className="h-8 w-8 flex-shrink-0 rounded-lg text-slate-400 hover:bg-slate-100 hover:text-slate-600"
      ...
      <nav className="flex-1 overflow-y-auto px-3 pb-2">
        {navGroups.map((group, groupIndex) => (
          <div key={group.title} className="mb-1">
            {/* Section label (colapsado: separador) */}
            {collapsed ? (
              groupIndex > 0 && <div className="mx-2 my-3 border-t border-slate-100" />
            ) : (
              ...
              {group.items.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      'group flex items-center gap-3 rounded-xl py-2.5 text-[13px] font-medium transition-all duration-200',
      ...
      <div className={cn('pb-2', collapsed ? 'px-2' : 'px-4')}>
        <div
          ...
          className={cn(
            'flex items-center gap-2.5 rounded-xl bg-slate-50 py-2.5',
      ...
      {/* User / logout */}
      {/* ----------------------------------------------------------------- */}
      <div className={cn('border-t border-slate-100 py-3', collapsed ? 'px-2' : 'px-4')}>
